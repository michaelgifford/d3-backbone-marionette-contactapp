ContactManager.module("Entities", function(Entities, ContactManager, Backbone, Marionette, $, _){
  ...
  var initializeContacts = function(){
    var contacts = new Entities.ContactCollection([
      { id: 1, firstName: "Alice", lastName: "Arten", phoneNumber: "555-0184", gender: "Female" },
      { id: 2, firstName: "Bob", lastName: "Brigham", phoneNumber: "555-0163", gender: "Male" },
      { id: 3, firstName: "Charlie", lastName: "Campbell", phoneNumber: "555-0129", gender: "Male" }
    ]);
